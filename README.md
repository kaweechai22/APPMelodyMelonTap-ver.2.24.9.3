...
## v24.4 Stable Recovery
- ใช้ระบบรับเสียง/ประมวลผลของ v24.3 เป็นหลัก
- ไม่ใช้ Ripeness AI v25 เพื่อเลี่ยงปัญหาไม่แสดงผล
- คงระบบความสุก 3 ช่วง ไม่แสดง "ดิบ"
- คงระบบเตือนโพรงด้วยเสียงจาก v24.3

## v24.5 Stable Ripeness Tune
- ยึดฐาน v24.4/v24.3 ที่รับเสียงเสถียร
- ไม่แตะ audio pipeline / FFT / tap detection
- ปรับเฉพาะ logic ระดับการสุกจากข้อมูล 210 คลิป
- ใช้ rule ที่สั้นและเสถียร: f_mean + band_150_300
- ตั้งใจลดความเสี่ยงแอปล่มแบบ v25
